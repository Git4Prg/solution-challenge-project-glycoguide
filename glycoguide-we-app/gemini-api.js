...
async function geminiPretrainedPrompts(inp, user) {
    ...
    let arr = [{ text: `input: age - ${user.age} , height - ${user.height}cm, weight - ${user.weight}kg, dietary preference - ${user.eatingPreference}, lactose intolerance - ${user.lactoseIntolerance}, gluten intolerance - ${user.glutenIntolerance}` }, { text: "output: " }]
